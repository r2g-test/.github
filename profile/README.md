...
- Organization defaults: https://github.com/r2g-test/.github
- Canonical agent policy: https://github.com/r2g-test/.github/blob/main/agents.md
- Security policy: https://github.com/r2g-test/.github/security/policy
